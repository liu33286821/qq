...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devServer: {
    ...
    before(app) {
      ...
      app.get('/api/getSingerInfo',function (req,res) {
      ...
      app.get('/api/searchhot',function (req,res) {
        let url = 'https://c.y.qq.com/splcloud/fcgi-bin/gethotkey.fcg?g_tk=2015885391&jsonpCallback=hotSearchKeysmod_top_search&loginUin=2243863884&hostUin=0&format=jsonp&inCharset=utf8&outCharset=utf-8&notice=0&platform=yqq&needNewCode=0'
        axios.get(url).then((response) => {
          res.json(response.data)
        })
      })
